...
import { getDAVClient, getNodeOrActive, getNodeResourceUrl, util } from "./util.js";
import { fileExtensionMap, showPreview, togglePreviewPane } from "./previews.js";
import { commandHtmlTemplateFile, commandHtmlTemplateFolder, createFolder, deleteResource, downloadFile, registerCommandButtons, showNotification, uploadFiles } from "./widgets.js";
...
registerCommandButtons("body", (e) => {
  ...
  switch (e.command) {
    ...
    case "copyUrl":
      navigator.clipboard
        .writeText(getNodeResourceUrl(node))
        .then(() => {
